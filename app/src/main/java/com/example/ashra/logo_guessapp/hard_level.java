...
public class hard_level extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer_btn1=(Button)findViewById(R.id.button8);
        answer_btn2=(Button)findViewById(R.id.button9);
        answer_btn3=(Button)findViewById(R.id.button10);
        answer_btn4=(Button)findViewById(R.id.button11);

        easyImage = findViewById(R.id.imageView6);
...
//                        mTextView.setText("Response is: "+ response.substring(0,500));
                        ...
                        try {
                            ...
                            String type = jsonResponse.getString("hard"); // {easy:}
