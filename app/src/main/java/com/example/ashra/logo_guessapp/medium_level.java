...
public class medium_level extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer_btn1=(Button)findViewById(R.id.button4);
        answer_btn2=(Button)findViewById(R.id.button5);
        answer_btn3=(Button)findViewById(R.id.button6);
        answer_btn4=(Button)findViewById(R.id.button7);

        easyImage = findViewById(R.id.imageView5);
...
//                        mTextView.setText("Response is: "+ response.substring(0,500));
                        ...
                        try {
                            ...
                            String type = jsonResponse.getString("medium"); // {easy:}
